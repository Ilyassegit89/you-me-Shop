...
//import {useFilterContext} from "../assets/context/Filter_context"
 ...
 const Filters = () => {
   const { state, dispatch } = useContext(DataContext);
     const { loading, filteredData, error, selectedCategory, activeButton, data } = state;
  ...
  console.log(`active button id ${activeButton}`);
            ...
            <div className="py-4 form-control">
                ...
                return (
                  <button
                    ...
                    name="category"
                    type="button"
                    className= {activeButton == index ? "px-2 underline text-gray-700" : "px-2 text-gray-200"}
