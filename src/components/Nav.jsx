...
function Nav() {
  ...
  return (
    <div
      className={
        scrolledNav
          ? "bg-[#eee] shadow-md sticky top-0 right-0 px-4 expanded  z-50 "
          : "sticky top-0 right-0 left-0  px-4  bg-[#eee] w-full h-13 "
      }
    >
      <div
        className={
      ...
      >
        ...
        <div
          className={
            nav
              ? "bg-white fixed left-0 top-0 h-full w-[60%] text-gray-400 px-4 transition duration-300 border-r-2 border-r-gray-500 z-50"
              : "bg-black fixed right-0 top-0 h-full w-[-100%]  p-4 hidden"
          }
        >
          <SideMenu />
        </div>
